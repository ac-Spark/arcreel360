"""GrokVideoBackend — xAI Grok 影片生成後端。"""
...
class GrokVideoBackend:
    ...
    async def generate(self, request: VideoGenerationRequest) -> VideoGenerationResult:
        ...
        logger.info("Grok 影片生成開始: model=%s, duration=%ds", self._model, request.duration_seconds)
        ...
        logger.info("Grok 影片下載完成: %s", request.output_path)
