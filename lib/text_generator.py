"""TextGenerator — 文字生成 + 用量追蹤包裝層。

類似 MediaGenerator，組合 TextBackend + UsageTracker，
呼叫方無需關心 usage tracking 細節。
"""
...
class TextGenerator:
    """組合 TextBackend + UsageTracker，統一封裝文字生成 + 用量追蹤。"""
    ...
    async def create(
        ...
        """工廠方法：根據任務型別建立對應的 backend + usage_tracker。"""
