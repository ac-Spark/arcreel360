...
export function VideoLightbox({ src, alt, poster, onClose }: VideoLightboxProps) {
  useEffect(() => {
      ...
      <div className="flex h-full w-full items-center justify-center p-5 sm:p-8 lg:p-12">
        ...
        >
          <video
            ...
            className="max-h-[calc(100vh-3rem)] max-w-[calc(100vw-2rem)] rounded-2xl border border-white/10 bg-black object-contain shadow-[0_30px_120px_rgba(0,0,0,0.55)] sm:max-h-[calc(100vh-5rem)] sm:max-w-[calc(100vw-4rem)]"
            controls
            autoPlay
            playsInline
          />
